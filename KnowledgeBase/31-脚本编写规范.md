...
- 本轮基于 `c231cf112cbb5018e4427c7f4e6e79e43c3a732c` 的隔离 worktree 复现 1 个源码指纹漂移：`ARCH-02`，来源是 Buqi `Battle` 目录中 Charge declare 排序与消耗契约更新。`SERVER-02`、`TOOLS-02`、`TOOLS-03`、`PACKAGE-01` 在该干净 worktree 没有匹配的源文件变化；本轮仅按可复现证据更新相关知识页并刷新指纹。
