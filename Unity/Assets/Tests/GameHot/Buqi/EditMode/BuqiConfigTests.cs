    ...
    public sealed class BuqiConfigTests
    {
        ...
        private static class BuqiConfigTestData
        {
            public static BuqiConfigCatalog CreateValidCatalog()
            {
                ...
                catalog.Echoes.Add(Echo("echo-fast-lesson", "fast", Instance("efl-deadline", "W8-006", BattleQuality.Fixed, 0, "A-06"), Instance("efl-board-a", "W8-005", BattleQuality.Fixed, 3, "A-06"), Instance("efl-board-b", "W8-005", BattleQuality.Improved, 5, "A-02"), Instance("efl-urgent", "W8-003", BattleQuality.Fixed, 7, "A-01"), Instance("efl-finisher", "W8-005", BattleQuality.Fixed, 8, "A-06")));
                catalog.Echoes.Add(Echo("echo-fast-early", "fast", Instance("efe-deadline", "W8-006", BattleQuality.Fixed, 0, "A-06"), Instance("efe-board-a", "W8-005", BattleQuality.Fixed, 3, "A-06"), Instance("efe-board-b", "W8-005", BattleQuality.Improved, 5, "A-02"), Instance("efe-urgent", "W8-003", BattleQuality.Fixed, 7, "A-01"), Instance("efe-finisher", "W8-005", BattleQuality.Normal, 8)));
                catalog.Echoes.Add(Echo("echo-buffer-lesson", "buffer", Instance("ebl-core-a", "W8-012", BattleQuality.Fixed, 0, "A-06"), Instance("ebl-core-b", "W8-012", BattleQuality.Fixed, 3, "A-06"), Instance("ebl-list", "W8-008", BattleQuality.Fixed, 6, "A-04"), Instance("ebl-shield", "W8-007", BattleQuality.Fixed, 7, "A-01"), Instance("ebl-shield-b", "W8-007", BattleQuality.Fixed, 8, "A-01"), Instance("ebl-shield-c", "W8-007", BattleQuality.Fixed, 9, "A-01")));
                catalog.Echoes.Add(Echo("echo-buffer-early", "buffer", Instance("ebe-core-a", "W8-012", BattleQuality.Fixed, 0, "A-06"), Instance("ebe-core-b", "W8-012", BattleQuality.Fixed, 3, "A-06"), Instance("ebe-list", "W8-008", BattleQuality.Fixed, 6, "A-04"), Instance("ebe-shield", "W8-007", BattleQuality.Fixed, 7, "A-01"), Instance("ebe-shield-b", "W8-007", BattleQuality.Normal, 8), Instance("ebe-shield-c", "W8-007", BattleQuality.Normal, 9)));
                ...
                catalog.Echoes.Add(Echo("echo-heal-lesson", "heal", Instance("ehl-flag", "W8-018", BattleQuality.Normal, 0), Instance("ehl-spring-a", "W8-017", BattleQuality.Normal, 3), Instance("ehl-spring-b", "W8-017", BattleQuality.Normal, 5), Instance("ehl-pack", "W8-016", BattleQuality.Normal, 7, "A-01"), Instance("ehl-spring-c", "W8-017", BattleQuality.Normal, 8)));
                catalog.Echoes.Add(Echo("echo-heal-early", "heal", Instance("ehe-flag", "W8-018", BattleQuality.Normal, 0), Instance("ehe-spring-a", "W8-017", BattleQuality.Normal, 3), Instance("ehe-spring-b", "W8-017", BattleQuality.Normal, 5), Instance("ehe-pack", "W8-016", BattleQuality.Normal, 7, "A-01"), Instance("ehe-spring-c", "W8-017", BattleQuality.Normal, 8)));
