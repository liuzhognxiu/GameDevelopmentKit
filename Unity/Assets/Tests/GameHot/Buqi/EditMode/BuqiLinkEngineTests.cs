...
namespace Game.Hot.Buqi.Tests
{
    public sealed class BuqiLinkEngineTests
    {
        ...
        public void BattleSimulation_UsesLinearAdjacencyForResponseAndTarget()
        {
            ...
            Check(listener.Charge > 0, "The linear left-adjacent target must resolve to the preceding slot.");
        ...
        {
            Check(BuqiBattleSimulator.RuleVersion == "0.6.0", "Linear topology requires a new rule version.");
