...
> 当前工程：Step 1/2/3、Charge v0.4.1 与内部效果验证库均已验收；当前验证库为 8 构筑方向、24 法门、6 淬炼、16 道影。P-1 已完成第 1 名自动构筑玩家的 3/3 轮，自走棋玩家与新手玩家尚未开始，体验门禁仍未通过。
...
P-1 不推翻已验收的确定性内核、配置链路或内部效果验证库，只决定卡面信息、道影公开量、三类准备选项和战报层级是否值得进入正式玩家流程。`24/6/16` 是工程覆盖面，不是体验门禁通过的替代证据。
