...
- Gate: [GATE-ID] (see references/studio/director-gates.md)
...
- Game pillars and core fantasy
- Platform and performance constraints (from `references/studio/technical-preferences.md` if configured)
