...
| `validate-skill-change.sh` | PostToolUse (Write/Edit) | Skill file changes | Advises running `/skill-test` after any `references/workflows/` file is written or edited |

Hook reference documentation: `references/studio/hooks-reference/`
Hook input schema documentation: `references/studio/hooks-reference/hook-input-schemas.md`
