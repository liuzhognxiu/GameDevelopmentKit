...
- Read `references/studio/technical-preferences.md` to identify the engine and version
...
Use the template structure from `references/studio/templates/game-design-document.md`:
...
Before finalizing the GDD, spawn `creative-director` via Task using gate **CD-GDD-ALIGN** (`references/studio/director-gates.md`).
