...
### Engine reference
Read `references/studio/technical-preferences.md`:
...
Read the `Engine Specialists` section of `references/studio/technical-preferences.md`
...
5. **Engine preferences**: `references/studio/technical-preferences.md` — read naming conventions and performance budgets
