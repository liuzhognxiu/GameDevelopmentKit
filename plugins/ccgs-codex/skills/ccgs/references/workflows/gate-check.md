...
- [ ] Technical preferences configured (`references/studio/technical-preferences.md` populated)
...
Before generating the final verdict, spawn all four directors as **parallel subagents** via Task using the parallel gate protocol from `references/studio/director-gates.md`. Issue all four Task calls simultaneously — do not wait for one before starting the next.

**Spawn in parallel:**

1. **`creative-director`** — gate **CD-PHASE-GATE** (`references/studio/director-gates.md`)
2. **`technical-director`** — gate **TD-PHASE-GATE** (`references/studio/director-gates.md`)
3. **`producer`** — gate **PR-PHASE-GATE** (`references/studio/director-gates.md`)
4. **`art-director`** — gate **AD-PHASE-GATE** (`references/studio/director-gates.md`)
...
- **No Difficulty Curve doc?** → Create `design/difficulty-curve.md` from the template at `references/studio/templates/difficulty-curve.md` — or use `/quick-design "difficulty curve"` for a guided session.
- **No player journey map?** → Create `design/player-journey.md` from the template at `references/studio/templates/player-journey.md` — or author it collaboratively using `/ux-design` Phase 2b.
