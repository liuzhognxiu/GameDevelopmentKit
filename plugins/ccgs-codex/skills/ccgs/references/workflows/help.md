...
Read `references/studio/workflow-catalog.yaml`. This is the authoritative list of all
...
After reading the catalog, Glob `references/workflows/*.md` to get the full list
