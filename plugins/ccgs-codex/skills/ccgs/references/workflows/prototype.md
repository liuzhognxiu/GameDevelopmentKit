...
Read `CLAUDE.md` and `references/studio/technical-preferences.md` for the engine and
language in use.
...
Read `references/studio/templates/prototype-report.md` to get the report structure.
