...
Verify `references/workflows/[name].md` exists. If not, stop with:
...
Read the full skill file at `references/workflows/[name].md`.
...
Ask: "May I write this improved version to `references/workflows/[name].md`?"
...
Write the improved skill to `references/workflows/[name].md`.
...
Ask: "May I revert `references/workflows/[name].md` using git checkout?"
If yes: run `git checkout -- references/workflows/[name].md`
