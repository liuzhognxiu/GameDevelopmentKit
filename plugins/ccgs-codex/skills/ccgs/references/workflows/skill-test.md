...
Validates `references/workflows/*.md` files for structural compliance and
...
- `static all` → run 7 structural checks on all skills (Glob `references/workflows/*.md`)
...
Glob `references/workflows/*.md` to get the complete list of skills.
