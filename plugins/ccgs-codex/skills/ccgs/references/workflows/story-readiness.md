...
See `references/studio/director-gates.md` for the full check pattern and mode definitions.
...
Spawn `qa-lead` via Task using gate **QL-STORY-READY** (`references/studio/director-gates.md`).
