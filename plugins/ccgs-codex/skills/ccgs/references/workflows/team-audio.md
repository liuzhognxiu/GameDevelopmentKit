...
Spawn the **primary engine specialist** in parallel (from `references/studio/technical-preferences.md` Engine Specialists) to validate the integration approach:
