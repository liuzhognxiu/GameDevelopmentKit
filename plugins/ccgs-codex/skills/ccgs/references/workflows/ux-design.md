...
> "Player journey map not yet created. Template available at `references/studio/templates/player-journey.md`. Run `/ux-design` Phase 2b or create it manually to establish player context for this screen."
...
Read `references/studio/technical-preferences.md` and extract the `## Input & Platform`
