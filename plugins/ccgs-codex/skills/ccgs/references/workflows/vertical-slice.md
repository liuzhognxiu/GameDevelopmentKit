...
- Naming conventions from `references/studio/technical-preferences.md`
...
Read `references/studio/templates/vertical-slice-report.md` to get the report structure.
...
- `full` → spawn `creative-director` via Task using gate **CD-PLAYTEST**
  (`references/studio/director-gates.md`).
